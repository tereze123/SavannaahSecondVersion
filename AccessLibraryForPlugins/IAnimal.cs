...
namespace AccessLibraryForPlugins.Animals
{
    public interface IAnimal
    {
        ...
        void EnemyIsInRangeMovementNextPosition(IAnimal[,] initialGeneration, 
        ...
        AccessLibraryForPlugins.PositionOnField EnemysPositionOnField(IAnimal[,] initialGeneration, 
            int rowPosition, 
            int columnPosition);

        void PeaceStateMovementNextPosition(IAnimal[,] initialGeneration, 
            IAnimal[,] nextGenerationArray, 
            int rowPosition, 
            int columnPosition);
    }
